...
namespace CheckWebApp
{
    public class Startuppa
    {
        ...
        public Startuppa(IConfiguration _configuration)
        {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CheckWebAppDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("CheckWebApp")));
